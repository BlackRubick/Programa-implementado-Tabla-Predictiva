...
class SimpleParser:
    ...
    def get_production(self, non_terminal, current_token):
        ...
        #numero_2 numeroa | s |
                ...
                return ["func_componente2", "func_componente3", "func_componente4", "func_componente5", "func_componente6", "s"]
            ...
            #    return ["}"]
                ...
                return ["main_componente2", "main_componente3", "main_componente4", "main_componente5", "main_componente6", "s"]
                ...
                return ["while_componente2", "while_componente3", "while_componente4", "while_componente5", "s"]
                ...
                if next_token.tipo == "ELSE":
                    return ["func_componente6", "con_componente7"]
                else:
                    return ["func_componente6", "s"]
